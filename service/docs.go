// Package service provides [SchedulerService], the built-in Google Cloud Spanner implementation for
// persisting and managing A2A scheduler crons.
//
// # SchedulerService
//
// [NewSchedulerService] opens a Spanner client, Cloud Scheduler client, Cloud Tasks client, and
...
//
// [SchedulerService.RegisterGRPC] and [SchedulerService.RegisterHTTP] mount the gRPC and HTTP
